...
shapes_colour = [(0, 255, 0), (255, 0, 0), (0, 255, 255), (255, 255, 255), (255, 255, 0), (255, 165, 0), (128, 0, 128)]
...
class Piece(object):
    def __init__(self, x, y, shape):
        ...
        self.y = y
        self.shape = shape
        self.colour = shapes_colour[shapes.index(shape)]
        self.rotation = 0
...
def draw_text_middle(text, size, color, surface):
    font = pygame.font.SysFont('comicsana', size, bold=True)
